                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade {if $ssr_prefer}active in{/if}" id="all_ssr">
                                            {$pre_user = URL::cloneUser($user)}
                                                ...
                                                {if $mergeSub!= true}
                                                <div>
                                                    <span class="icon icon-lg text-white">flash_auto</span> 节点订阅地址：
                                                </div>
                                                <div class="float-clear">
                                                    ...
                                                    <button class="copy-text btn btn-subscription col-xx-12 col-sm-3 col-lg-2" type="button" data-clipboard-text="{$subUrl}{$ssr_sub_token}?mu=1">点击复制到服务器订阅处</button>
                                                </div>
                                                {else}
                                                <div>
                                                ...
                                                <br>
                                                    ...
                                                    {if $mergeSub!= true }
                                                        <button class="copy-text btn btn-subscription" type="button" data-clipboard-text="{$ssr_url_all_mu}">点击复制链接</button>
                                                    {else}
